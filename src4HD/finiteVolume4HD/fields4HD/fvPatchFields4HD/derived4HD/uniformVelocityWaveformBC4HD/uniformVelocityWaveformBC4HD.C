...
#include "uniformVelocityWaveformBC4HD.H"
...
uniformVelocityWaveformBC4HD::uniformVelocityWaveformBC4HD
(
    const fvPatch& p,
...
uniformVelocityWaveformBC4HD::uniformVelocityWaveformBC4HD
(
    const uniformVelocityWaveformBC4HD& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
uniformVelocityWaveformBC4HD::uniformVelocityWaveformBC4HD
(
    const uniformVelocityWaveformBC4HD& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::uniformVelocityWaveformBC4HD::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::uniformVelocityWaveformBC4HD::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::uniformVelocityWaveformBC4HD::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
void uniformVelocityWaveformBC4HD::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void uniformVelocityWaveformBC4HD::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, uniformVelocityWaveformBC4HD);
