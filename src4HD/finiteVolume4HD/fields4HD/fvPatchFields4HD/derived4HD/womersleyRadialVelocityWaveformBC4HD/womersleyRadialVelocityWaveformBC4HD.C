...
#include "womersleyRadialVelocityWaveformBC4HD.H"
...
womersleyRadialVelocityWaveformBC4HD::womersleyRadialVelocityWaveformBC4HD
(
    const fvPatch& p,
...
womersleyRadialVelocityWaveformBC4HD::womersleyRadialVelocityWaveformBC4HD
(
    const womersleyRadialVelocityWaveformBC4HD& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
womersleyRadialVelocityWaveformBC4HD::womersleyRadialVelocityWaveformBC4HD
(
    const womersleyRadialVelocityWaveformBC4HD& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::womersleyRadialVelocityWaveformBC4HD::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4HD::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::womersleyRadialVelocityWaveformBC4HD::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4HD::radialVelocityFunction(scalar t, scalar r)
{
    scalar re0_(0.0);
    if (fourierSeriesType_ == "real")
    {
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4HD::velocityAverage()
{
...
void womersleyRadialVelocityWaveformBC4HD::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void womersleyRadialVelocityWaveformBC4HD::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, womersleyRadialVelocityWaveformBC4HD);
