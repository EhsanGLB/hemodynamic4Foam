...
#include "powerLawRadialVelocityBC4HD.H"
...
powerLawRadialVelocityBC4HD::powerLawRadialVelocityBC4HD
(
    const fvPatch& p,
...
powerLawRadialVelocityBC4HD::powerLawRadialVelocityBC4HD
(
    const powerLawRadialVelocityBC4HD& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
powerLawRadialVelocityBC4HD::powerLawRadialVelocityBC4HD
(
    const powerLawRadialVelocityBC4HD& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void powerLawRadialVelocityBC4HD::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void powerLawRadialVelocityBC4HD::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, powerLawRadialVelocityBC4HD);
