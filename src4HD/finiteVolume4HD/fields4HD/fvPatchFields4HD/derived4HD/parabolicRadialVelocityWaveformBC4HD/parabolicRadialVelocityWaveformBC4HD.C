...
#include "parabolicRadialVelocityWaveformBC4HD.H"
...
parabolicRadialVelocityWaveformBC4HD::parabolicRadialVelocityWaveformBC4HD
(
    const fvPatch& p,
...
parabolicRadialVelocityWaveformBC4HD::parabolicRadialVelocityWaveformBC4HD
(
    const parabolicRadialVelocityWaveformBC4HD& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
parabolicRadialVelocityWaveformBC4HD::parabolicRadialVelocityWaveformBC4HD
(
    const parabolicRadialVelocityWaveformBC4HD& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::parabolicRadialVelocityWaveformBC4HD::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::parabolicRadialVelocityWaveformBC4HD::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::parabolicRadialVelocityWaveformBC4HD::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
void parabolicRadialVelocityWaveformBC4HD::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void parabolicRadialVelocityWaveformBC4HD::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, parabolicRadialVelocityWaveformBC4HD);
