...
#include "parabolicRadialVelocityBC4HD.H"
...
parabolicRadialVelocityBC4HD::parabolicRadialVelocityBC4HD
(
    const fvPatch& p,
...
parabolicRadialVelocityBC4HD::parabolicRadialVelocityBC4HD
(
    const parabolicRadialVelocityBC4HD& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
parabolicRadialVelocityBC4HD::parabolicRadialVelocityBC4HD
(
    const parabolicRadialVelocityBC4HD& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void parabolicRadialVelocityBC4HD::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void parabolicRadialVelocityBC4HD::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, parabolicRadialVelocityBC4HD);
